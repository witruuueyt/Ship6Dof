...
namespace game4automation
{
    ...
    public class IKTarget : BehaviorInterface
    {
        ...
        [game4automation.ReadOnly] public Vector3 RotRH; //!< Rotation of the target in right handed robot coordinates
        ...
        [game4automation.ReadOnly]public Vector3 PositionCorrection = new Vector3(0, 0, 0); //!< Correction of the position (because of inaccuracies of the robotik)
        [game4automation.ReadOnly]public float PositionFailure = 0;//!< Position failure in m
        ...
        [game4automation.ReadOnly] public string[] Solutions = new string[8]; //!< Solutions of the IK for this target
        [game4automation.ReadOnly] public float[] AxisPos = new float[6];//!< Axis positions of the IK for this target
        [game4automation.ReadOnly] public RobotIK RobotIK; //!< Robot IK of the robot
        [game4automation.ReadOnly] public bool Reachable; //!< If true the target is reachable by the robot
