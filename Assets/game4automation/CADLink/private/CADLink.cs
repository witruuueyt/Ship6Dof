...
namespace game4automation
{
    ...
    public class CADLink : MonoBehaviour
    {
...
#if UNITY_EDITOR
        [Header("Import Options")] [ShowIf("IsCad")] [Header("Import Options")]
        ...
        [EnableIf("SetAndCreateMaterials")] public string NewMaterialPath = "Assets/game4automation/CADLink/Materials";
        ...
        private GameObject StepImport(GameObject root)
        {
            ...
            occHierarchyMarshaller.MarshallRootNode(intPtr, root);
        ...
        {
#if GAME4UTOMATIOGAME4AUTOMATION_PROFESSIONAL
            CADUpdater cadupdater = GetComponent<CADUpdater>();
            var updateTransform = transform.Find("Update");
            if (updateTransform != null)
            {
