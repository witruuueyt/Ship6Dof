...
#pragma warning disable 0414
    ...
    public class TransportSurface : BaseTransportSurface
    {
        ...
        [InfoBox("Standard Setting for layer is g4a Transport")] [OnValueChanged("RefreshReferences")]
       ...
       [ReadOnly]public List<Rigidbody> LoadedPart = new List<Rigidbody>();
        ...
        new void Awake()
        {
            if (ParentDrive != null || OnEnter != null || OnExit != null  || ChangeConstraintsOnEnter || ChangeConstraintsOnExit )
            {
        ...
        private bool OnContact(ref ContactData data)
        {
            ...
            else
            {
                ...
                foreach (ref var point in data.Points)
                {
                    ...
                    point.SurfaceVelocity = -global * speed *  Game4AutomationController.SpeedOverride / Game4AutomationController.Scale;;
                }
            }
            ...
            if (!Radial)
            {
                ...
                if (parentdrivenotnull)
                {
                    ...
                    if (DebugMode)
                    {
                        ...
                        Global.DebugDrawArrow(transform.position+new Vector3(0,0.5f,0),deltaArea*1000,Color.green);
