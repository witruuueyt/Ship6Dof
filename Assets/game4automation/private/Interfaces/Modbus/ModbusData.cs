...
public class ModbusData : MonoBehaviour
{
    ...
    [ShowIf("IsByte")][Dropdown("ByteValues")] public int RegisterByte = 0;
    public ModbusType Type;
    [ShowIf("IsBit")]
    [Dropdown("BitValues")] public int Bit = 0;
    ...
    private bool IsBit()
    {
        return (Type == ModbusType.BOOL && (Register == RegisterType.InputRegister || Register == RegisterType.OutputRegister));
    }
