...
#if GAME4AUTOMATION_JSON
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;
#endif
using UnityEditor;
#if GAME4AUTOMATION_BESTHTTP
...
namespace game4automation
{
    ...
    { 
#if !GAME4AUTOMATION_BESTHTTP || !GAME4AUTOMATION_JSON
        [InfoBox("This interface requires BESTHTTP And Newtonsoft JSON . You need to purchase BESTHTTP on the Unity Asset Store. Newtonsoft JSON needs to be added in the manifest.json. After both is installed please put GAME4AUTOMATION_BESTHTTP and GAME4AUTOMATION_JSON into your Scripting Define Symbols in Player Settings",EInfoBoxType.Error)]
#endif
