...
using System.Text;
#if GAME4AUTOMATION_BESTHTTP || GAME4AUTOMATION_BESTMQTT
using BestMQTT;
...
namespace game4automation
{
    ...
    {
        #if !GAME4AUTOMATION_BESTHTTP && !GAME4AUTOMATION_BESTMQTT
        [InfoBox("For using this interface you need to purchase on the Unity Asset Store BestHTTP and BestMQTT and you need to set GAME4AUTOMATION_BESTHTTP and GAME4AUTOMATION_BESTMQTT in the Scripting Define Symbols (Project Settings > Player)",EInfoBoxType.Warning)]
        #endif
