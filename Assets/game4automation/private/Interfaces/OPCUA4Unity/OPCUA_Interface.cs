...
public bool IsReconnecting;
        ...
        public string ApplicationName = "game4automation";

        [Tooltip("The appliction URN of the OPC Client")]
        public string ApplicationURN = "urn:game4automation";

        [Tooltip("The appliction URI of the OPC Client")]
        public string ProductURI = "uri:game4automation";
...
#if GAME4AUTOMATION
        [Tooltip("Automatically creates Game4Automation Signals")]
        ...
        public void AttemptConnection()
        {
            ...
            {
                // 连接成功的逻辑
                Debug.Log("OPCUA Interface - Connection successful!");
                IsConnected = true;
            ...
            {
                // 连接失败的逻辑
                Debug.LogError("OPCUA Interface - Connection failed!");
                IsConnected = false;
