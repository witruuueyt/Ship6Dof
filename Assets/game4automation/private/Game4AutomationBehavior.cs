...
namespace game4automation
{
    ...
    public class Game4AutomationBehavior : MonoBehaviour
    {
        ...
        [HideInInspector] public Game4AutomationController Game4AutomationController;
        ...
        protected void InitGame4Automation()
        {
            ...
            var controllers = FindObjectsOfType<Game4AutomationController>();
            foreach (var controller in controllers)
            {
                if (SceneIsAdditive)
                {
                    ...
                    {
                        Game4AutomationController = controller;
                    }
                }
                else
                {
