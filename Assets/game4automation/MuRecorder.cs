...
namespace game4automation
{
    ...
    public class MuRecorder : Game4AutomationBehavior
    {
        ...
        public new void Awake()
        {
            ...
            if (!MuSource.OnCreateDestroyComponents.Contains("game4automation.MuRecorder"))
            {
                MuSource.OnCreateDestroyComponents.Add("game4automation.MuRecorder");
            }
            base.Awake();
